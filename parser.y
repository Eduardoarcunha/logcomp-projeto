...
%token NEWLINE LBRACE RBRACE LPAREN RPAREN SEMICOLON EQUALS OR AND EQUALITY GREATER LESS PLUS MINUS MULT DIV NOT PRINTLN IF ELSE COMBAT WHILE PROGRESS ACTION CHARACTER MONSTER INT SCANLN IDENTIFIER NUMBER STRING
